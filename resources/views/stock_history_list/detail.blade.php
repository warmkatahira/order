<x-app-layout>
    ...
    <div class="py-3 px-4 grid grid-cols-12">
        <div class="col-span-12 grid grid-cols-12 gap-4">
            <div class="col-span-2 rounded-lg bg-emerald-100 text-sm text-center py-3 px-2 border border-black">
                <p>在庫計上ID</p>
            ...
            <div class="col-span-6 rounded-lg bg-emerald-100 text-sm text-left py-3 px-2 border border-black">
                <p>コメント</p>
