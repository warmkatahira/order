...
// モーダル要素
var modal = document.getElementById('store_register_modal');
var modal_header = document.getElementById('modal_header');
var store_register_enter = document.getElementById('store_register_enter');
var operation_type = document.getElementById('operation_type'); // 登録情報要素

var store_name = document.getElementById('store_name');
var store_zip_code = document.getElementById('store_zip_code');
var store_address_1 = document.getElementById('store_address_1');
var store_address_2 = document.getElementById('store_address_2');
var store_tel_number = document.getElementById('store_tel_number');
var store_id = document.getElementById('store_id'); // 店舗登録モーダルを開く

$("[id=store_register_modal_open]").on("click", function () {
  // モーダルの文字を変更
  modal_header.innerHTML = '店舗登録画面';
  store_register_enter.innerHTML = '登録'; // オペレーションタイプを設定

  operation_type.value = 'add'; // モーダルを開く
...
$("[class^=store_register_modal_close]").on("click", function () {
  ...
  store_tel_number.value = null; // モーダルを閉じる
...
$("[id=store_register_enter]").on("click", function () {
  // フォーム要素を取得
  var form = document.getElementById('store_register_form');
  ...
  try {
    ...
    var result = window.confirm('店舗登録を実行しますか？'); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
...
$("[class^=store_delete]").on("click", function () {
  ...
  var result = window.confirm('以下の店舗を削除しますか？\n\n' + store_name); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
...
$("[class^=store_modify]").on("click", function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      store_id.value = data['store']['store_id']; // モーダルの文字を変更

      modal_header.innerHTML = '店舗変更画面';
      store_register_enter.innerHTML = '変更'; // オペレーションタイプを設定

      operation_type.value = 'mod'; // モーダルを開く
