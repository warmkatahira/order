...
(() => {
/*!*************************************!*\
  !*** ./resources/js/order_input.js ***!
  \*************************************/
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
// モーダル要素
var modal = document.getElementById('store_select_modal');
var store_select = document.getElementById('store_select');
var store_search = document.getElementById('store_search'); // 要素

var shipping_store_name = document.getElementById('shipping_store_name');
var shipping_store_zip_code = document.getElementById('shipping_store_zip_code');
var shipping_store_address_1 = document.getElementById('shipping_store_address_1');
var shipping_store_address_2 = document.getElementById('shipping_store_address_2');
var shipping_store_tel_number = document.getElementById('shipping_store_tel_number');
var store_pic = document.getElementById('store_pic');
...
var operation_type = document.getElementById('operation_type'); // アイテム削除ボタンが押下されたら
...
$("[class^=order_item_delete]").on("click", function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      // tr要素を削除
      var element = document.getElementById(delete_item_id);
      element.remove(); // order_item_deleteクラスが存在していなかったらページを更新
...
$("[id=store_search_enter]").on("click", function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      // 店舗名のセレクトボックスをクリア
      for (var i = store_select.childElementCount; i >= 0; i--) {
        store_select.remove(i);
      } // 検索条件に一致した店舗をセレクトボックスに追加


      data['stores'].forEach(function (value) {
        var store_op = document.createElement('option');
  ...
  if (store_select.value != '') {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        shipping_store_tel_number.value = data['store']['store_tel_number']; // モーダルを閉じる
...
$("[class^=order_quantity]").on("change", function () {
  // 数量を変更する商品IDを取得
  var target_item_id = $(this).parent().parent().attr('id'); // 変更する数量を取得
...
$("[id=order_enter]").on("click", function () {
  try {
    var result = window.confirm('発注を行いますか？'); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
