...
// モーダル要素
var modal = document.getElementById('item_register_modal');
var modal_header = document.getElementById('modal_header');
var item_register_enter = document.getElementById('item_register_enter');
...
var item_jan_code = document.getElementById('item_jan_code');
var item_name = document.getElementById('item_name');
var item_id = document.getElementById('item_id'); // 商品登録モーダルを開く

$("[id=item_register_modal_open]").on("click", function () {
  // モーダルの文字を変更
  modal_header.innerHTML = '商品登録画面';
  item_register_enter.innerHTML = '登録'; // オペレーションタイプを設定
...
$("[id=item_register_enter]").on("click", function () {
  // フォーム要素を取得
  var form = document.getElementById('item_register_form');
  ...
  try {
    ...
    var result = window.confirm('商品登録を実行しますか？'); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
...
$("[class^=item_modify]").on("click", function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      item_id.value = data['item']['item_id']; // モーダルの文字を変更

      modal_header.innerHTML = '商品変更画面';
      item_register_enter.innerHTML = '変更'; // オペレーションタイプを設定
